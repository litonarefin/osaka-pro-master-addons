...
function osaka_light_copyrights_text(){
    ...
    if(!empty($copyright_text)){
        ...
        echo '<span>'. esc_html__( 'Developed by','osaka-light') . ' <a href="' . esc_url( 'https://prowptheme.com/themes/osaka/', 'osaka-light' ) . '" target="_blank" rel="nofollow">' . esc_html__('ProWPTheme','osaka-light') . '</a></span>';
    } else {
...
function osaka_pro_dequeue_scripts(){
    ...
    if(isset($osaka_options['osaka_dequeue_styles'])){
