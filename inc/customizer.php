...
require get_template_directory() . '/inc/customizer-pro/controls/text-controls.php';
require get_template_directory() . '/inc/customizer-pro/controls/category-controls.php';
...
if ( !function_exists('osaka_light_default_theme_options') ) :
    function osaka_light_default_theme_options() {
        $default_theme_options = array(
            ...
            'copyright_text'        => '<span>Copyright &copy;' . date('Y') . ' <a href="' . esc_url( 'https://prowptheme.com/themes/osaka/', 'osaka-light' ) . '" target="_blank" rel="nofollow">' . esc_html__('Osaka','osaka-light') . '</a> ' . esc_html__( ' | All rights reserved ','osaka-light') . '</span>',
            'facebook'              => '',
            'twitter'               => '',
            'instagram'             => '',
            'skype'                 => '',
