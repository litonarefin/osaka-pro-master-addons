		...
		<div class="respond">
			...
			<?php
				...
				$comments_args = array(
					...
					// 'comment_notes_after' 		=> '',
					'id_submit'					=> 'submit',
					'comment_field'             => '<p class="form-input"><label for="comment">' . esc_html__('Comment', 'osaka-light') . '</label><textarea name="comment" id="comment" class="wpcf7-form-control" cols="30" rows="5" placeholder="' . esc_html__('Your Comment', 'osaka-light') . '" required></textarea></p>',
					'label_submit'              => esc_html__( 'Submit Comment' , 'osaka-light' )
					);
